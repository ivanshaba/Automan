...
export const PLANS = [
    {
        ...
        features: [
            ...
            { text: "Up to 100 checks", limit: "100 checks" },
            { text: "business analysis" },
            { text: "Track engagements", tooltip: "1K engagements/month" },
            { text: "Community support", tooltip: "Get answers your questions" },
            { text: "AI powered suggestions", tooltip: "Get up to 100 AI powered suggestions" },
        ],
        btn: {
            text: "Start for free",
    ...
    },
    {
        ...
        features: [
            { text: "Security checks" },
            { text: "Up to 500 checks", limit: "500 checks" },
            { text: "business analysis" },
            { text: "Track engagements", tooltip: "20K engagements/month" },
            { text: "Export  data", tooltip: "Upto 1K data" },
            { text: "Priority support", tooltip: "Get 24/7 chat support" },
            { text: "AI powered suggestions", tooltip: "Get up to 500 AI powered suggestions" },
        ],
        btn: {
    ...
    },
    {
        ...
        features: [
            ...
            { text: "Up to 500 checks", limit: "500 checks" },
            { text: "business analysis" },
            { text: "Track engagements", tooltip: "Unlimited engagements" },
            { text: "Export  data checks", tooltip: "Unlimited data checks" },
            { text: "Dedicated manager", tooltip: "Get priority support from our team" },
            { text: "AI powered suggestions", tooltip: "Get unlimited AI powered suggestions" },
        ],
        btn: {
