    ...
    return (
        <MaxWidthWrapper className="max-w-3xl mx-auto px-8 mb-40">
            <AnimationContainer delay={0.1} className="w-full">
                ...
                <p className="mt-4">
                    Welcome to Automan. These terms and conditions outline the rules and regulations for the use of Automan&apos;s website and services.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    Automan reserves the right to modify these terms at any time. We will notify you of any changes by updating the &quot;Last updated&quot; data at the top of this page. You continued use of our website and services after any modifications indicates your acceptance of the new terms.
                </p>
                ...
                <p className="mt-8">
                    To use Automan, you must be at least 18 years old and capable of entering into a binding contact.
                </p>
                ...
                <div className="mt-8">
                    ...
                    <ul className="list-disc text-muted-foreground ml-8">
                        ...
                        <li>Attempting to gain unauthorized access to other user accounts or automan&apos;s systems.</li>
                    </ul>
                </div>
                ...
                <p className="mt-8 text-muted-foreground">
                    Automan reserves the right to suspend or terminate your account at any time, with or without notice, for any reason, including but not limited to violation of these terms.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    Automan is provided on an &quot;as is&quot; and &quot;as available&quot; basis. We do not warrant that the service will be uninterrupted, error-free, or free from viruses or other harmful components.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    In no event shall Automan be liable for any indirect, incidental, special, or consequential damages arising out of or in connection with your use of the service.
                </p>
                ...
                <p className="mt-8 text-muted-foreground">
                    If you have any questions or concerns about this Privacy Policy, please contact us at support@automansolutions.com
                </p>

                <p className="mt-8 font-medium">
                    By using automan, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions.
                </p>
            </AnimationContainer>
        </MaxWidthWrapper>
    );
