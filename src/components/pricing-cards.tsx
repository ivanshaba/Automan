                ...
                {PLANS.map((plan) => (
                    ...
                    >
                        <CardHeader className={cn(
                            ...
                            plan.name === "Pro" ? "green-500/[0.07]" : "bg-foreground/[0.03]"
                        )}>
                        ...
                        <CardFooter className="w-full mt-auto">
                            <Link
                                href={plan.btn.href}
                                style={{ width: "100%" }}
                                className={buttonVariants({ className: plan.name === "Pro" && "green-500 hover:green-500/80 text-white" })}
                            >
                                {plan.btn.text}
                            </Link>
                        </CardFooter>
                    ...
                    >
                            ...
                            <h5 className="text-3xl font-semibold flex items-end">
                                ...
                                {plan.name !== "Free" && (
                                    <motion.span
                                        ...
                                        className="px-2 py-0.5 ml-2 rounded-md bg-green7-500 text-foreground text-sm font-medium"
                                    >
                                        -12%
                                    </motion.span>
                                )}
                        ...
                        <CardFooter className="w-full pt- mt-auto">
                            <Link
                                href={plan.btn.href}
                                style={{ width: "100%" }}
                                className={buttonVariants({ className: plan.name === "Pro" && "green-500 hover:bg-green-500/80 text-white" })}
                            >
                                {plan.btn.text}
                            </Link>
                        </CardFooter>
